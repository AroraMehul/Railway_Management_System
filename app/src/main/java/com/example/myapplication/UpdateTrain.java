...
//create a list of items for the spinner.
        String[] items = new String[]{"Name", "Seat_Sleeper", "Seat_First_Class_AC", "Seat_Second_Class_AC","Seat_Third_Class_AC"};
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(newVal.getText().toString().compareTo(confVal.getText().toString()) == 0){
                    ...
                    messageSender.execute("8" + id.getText().toString()  + "/" +dropdown.getSelectedItem() + "/" + newVal.getText().toString());
                }
                else{
